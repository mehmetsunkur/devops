...
sudo virsh attach-disk winc /dev/disk/by-id/nvme-SAMSUNG_MZVLB2T0HMLB-00000_S4C2NY0N202137 vdc --config --type disk --targetbus sata
sudo virsh attach-disk winc /dev/disk/by-id/nvme-SAMSUNG_MZVLB2T0HMLB-00000_S4C2NY0N202137 vdc --config --type disk --targetbus scsi
